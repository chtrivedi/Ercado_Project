        ...
        <aside id="sidebar_left" class="nano nano-primary">
            <div class="nano-content">
                ...
                <ul class="nav sidebar-menu">
                    <!--<li class="sidebar-label pt20">Quick Access</li>
                    ...
                    <li class="sidebar-label pt15">Masters</li>
                        <li>
                            ...
                            <ul class="nav sub-nav">
                                <li>
                                    <a href="add_articles.php">
                                        <span class="glyphicons glyphicon-plus"></span> Add Article </a>
                                </li>
                                <li>
                                    <a href="articles.php">
                                        <span class="glyphicons glyphicons-edit"></span> View / Edit Articles</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="nav sub-nav">
                                <li>
                                    <a href="product_add.php">
                                        <span class="glyphicons glyphicon-plus"></span> Add Product </a>
                                </li>
                                <li>
                                    <a href="products.php">
                                        <span class="glyphicons glyphicons-edit"></span> View / Edit Products</a>
                                </li>
                            </ul>
                        </li>
                </ul>
